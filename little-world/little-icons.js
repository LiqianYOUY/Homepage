...
// Navigation marks share the envelope’s rounded, currentColor line style.
const roomIcon=paths=>`<svg class="room-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${paths}</svg>`;
export const roomIcons={
 overview:roomIcon('<path d="m3 10 9-7 9 7M5 9v12h14V9M9 21v-8h6v8"/>'),
 living:roomIcon('<path d="M5 12V8a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v4M4 11a2 2 0 0 1 2 2v2h12v-2a2 2 0 0 1 4 0v6H2v-6a2 2 0 0 1 2-2ZM5 19v2m14-2v2"/>'),
 study:roomIcon('<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M4 9h16M4 15h16M8 3v6m5-6 2 6M9 9v6m7-6v6M8 15v6m5-6v6"/>'),
 master:roomIcon('<path d="M3 20V9m18 11V9M3 16h18M5 11V5h14v6M3 11h18v5H3Z"/><path d="M8 8h2m4 0h2"/>'),
 terrace:roomIcon('<path d="M12 21v-9M12 16C4 17 3 10 3 10s8-2 9 6Zm0-4C11 4 20 3 20 3s1 8-8 9ZM8 21h8"/>')
};
export const fryingPanIcon=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="room-icon" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="9.5" cy="14.5" r="6.8"/><path d="m14.3 9.7 5.5-5.5a1.4 1.4 0 0 1 2 2l-6 5.8M6.3 12.1a4 4 0 0 1 4.7-1.2"/></svg>`;
export const footprintsIcon=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="room-icon" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><g transform="translate(3.5 10) rotate(-18 3 5)"><path d="M3 0C1.3 0 .5 1.5 .5 3.2L.9 7h4.2l.4-3.8C5.5 1.5 4.7 0 3 0Zm-1.8 9h3.6v1.3a1.8 1.8 0 0 1-3.6 0Z"/></g><g transform="translate(13 1.8) rotate(18 3 5)"><path d="M3 0C1.3 0 .5 1.5 .5 3.2L.9 7h4.2l.4-3.8C5.5 1.5 4.7 0 3 0Zm-1.8 9h3.6v1.3a1.8 1.8 0 0 1-3.6 0Z"/></g></svg>`;
