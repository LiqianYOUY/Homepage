...
function drawMap(canvas,{friend=null,poster=false}={}){
 ...
 if(poster){ctx.textAlign='left';ctx.fillStyle='#506746';ctx.font=`500 ${w*.031}px sans-serif`;ctx.fillText('A LITTLE WORLD · TOGETHER',pad,h*.10);ctx.font=`400 ${w*.015}px sans-serif`;ctx.fillText('Somewhere on this planet, you are here.',pad,h*.90);}
